...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            if (placa == null) throw new NullPointerException("O carro deve conter placa.");
            if (cor == null) throw new NullPointerException("É obrigatório informar a cor do carro.");
