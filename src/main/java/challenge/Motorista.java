...
public class Motorista {
  ...
  public static class MotoristaBuilder {
    ...
    public MotoristaBuilder withIdade(int idade) {
      if (idade < 0) {
        throw new IllegalArgumentException("A idade não pode ser valor negativo");
      }
      this.idade = idade;
      return this;
    }
    ...
    public Motorista build() {
      if (habilitacao == null) throw new NullPointerException("O motorista deve ter habilitação.");
      if (nome == null) throw new NullPointerException("Deve informar o nome do motorista.");
